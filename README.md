...
- MIUI requires acceptance of `Install via USB`. You need to tap `Accept` twice.
...
NOTE: This project was originally taken (and modified) from the repository at https://github.com/juandes/mobiledet-tflite-nnapi.

- Load images stored at the media pictures directory, and do inference on each image with `DetectorTest`.
...
NOTE: This project was originally taken (and modified) from the official TensorFlow examples repository at https://github.com/tensorflow/examples/tree/master/lite/examples/object_detection/android. This README is exactly the same from the project.
